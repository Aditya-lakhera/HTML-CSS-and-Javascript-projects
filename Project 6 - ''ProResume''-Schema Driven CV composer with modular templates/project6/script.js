 ...
 [
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Summary",
        type: "textarea",
        placeholder: "Your 2-3 sentence professional snapshot",
        rows: 3,
      },
    ],
  },
...
//DOM ACCESS HERE
const form = document.getElementById("resumeForm"); //line 99
const preview = document.getElementById("resumePreview");//line 144
const templateSelect = document.getElementById("templateSelect");//line  94
const downloadBtn = document.getElementById("downloadBtn");//line 79
const resetBtn = document.getElementById("resetBtn");//line 50
const templatePills = document.getElementById("templatePills");//line 59
const templateCount = document.getElementById("templateCount");//line  32
const sectionCount = document.getElementById("sectionCount");//line 36
const fieldProgress = document.getElementById("fieldProgress");//line 40
const sectionNav = document.getElementById("sectionNav");//line 85
const liveMeta = document.getElementById("liveMeta");//line 114
const previewPane = document.querySelector(".preview-pane");//line 143
const previewBgButtons = document.querySelectorAll("[data-preview-bg]");//line 122 ,129
const themeToggle = document.getElementById("themeToggle");//line  53
